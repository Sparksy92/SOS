...
export const DEFAULT_STEPS = {
  ...
  "2": { id: 2, label: "Confirm Ranger/Ollama connection", description: "Verify R.A.N.G.E.R. is responsive. Check settings to ensure it communicates with Ollama locally." },
  ...
  "7": { id: 7, label: "Confirm mission creation + mission brief", description: "Start a test mission (e.g. 'Water Run') and request R.A.N.G.E.R. for a status brief." },
