...
export const OFFLINE_TOOLKIT_CATALOG = [
  ...
  },
  {
    ...
    offlineImportance: "Critical for offline navigation, route planning, search-and-rescue, and manual position awareness.",
    difficulty: "Easy",
  ...
  },
  {
    ...
    offlineImportance: "Allows sending text messages and manual coordinates between teammates' external LoRa hardware devices.",
    difficulty: "Medium",
